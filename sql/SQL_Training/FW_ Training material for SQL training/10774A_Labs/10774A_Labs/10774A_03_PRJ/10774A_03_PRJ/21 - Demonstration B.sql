...
-- Step 1: Change database context to the TSQL2012 database (on-premise only)
-- If using SQL Azure, open a new query window with the connection pointing to the TSQL2012 database
